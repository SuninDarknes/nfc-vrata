                    ...
                    <div class="card bg-white rounded shadow p-2 h-100">
                        <div class="card-body">
                            <div class="row align-items-center text-center">
                                <div class="col-md-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="currentColor" class="bi bi-house-gear" viewBox="0 0 16 16">
                ...
                <a href="/kontrolaulaza/admin.php" class="card-link text-decoration-none">
                    <div class="card bg-white rounded shadow p-2 h-100">
                        <div class="card-body">
                            <div class="row align-items-center text-center">
                                <div class="col-md-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="currentColor" class="bi bi-graph-up" viewBox="0 0 16 16">
